...
\maketitle
  ...
  \paragraph{}
  Celem projektu jest napisanie systemu, pozwalającego użytkownikowi na zakładanie i porwadzenie mikroblogów wraz zmożliwością po Aplikacja zostanie napisana w języku jruby z wykorzystaniem framework'a Ruby on Rails.
  \begin{itemize}
    \item Platforma : JVM
    \item Język impementacji : jruby, coffescript
  ...
  \paragraph{}
  W pracy nad projektem zamierzamy wykorzystać metodologię SCRUM, która zakłada podział projektu na małe zadania, nie moduły. Z tego względu nie jesteśmy wstanie określić kto będzie się zajmował jaką częścią projektu. Taski będą w miarę postępu prac przypisane członkom zespołu.
  \paragraph{}
