...
iteracji algorytmu. Jak widać mimo, iż czas generowania płytki o rozmiarze 32x32 jest najkrótszy, jest to najmniej ekonomiczna
forma generowania fraktala. By stworzyć obrazek o wielkoci 256x256, musielibyśmy wygenerować 64 płytki, co dla pojedynczego
workera zwiększa czas dziesięciokrotnie. To zastosowanie miałoby sens, tylko przy bardzo dużej liczbie workerów. 
