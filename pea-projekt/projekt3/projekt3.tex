...
\paragraph{}
Spośród przedstawionych algorytmów, algorytm symulowanego wyżarzania najlepiej sprawdzi się w sytuacji kiedy rozwiązani danego problemu jest potrzebne w krótkim czasie, a duża dokładności wyników nie jest wymagana. W przeciwnym wypadku należy przeprowadzić bardziej dogłębne badania nad doborem parametrów i metody wyznaczania sąsiedztwa lub krzyżowania osobników dla algorytmów genetycznych oraz tabu search.
